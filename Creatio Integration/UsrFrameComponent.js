define("UsrFrameComponent", ["@creatio-devkit/common"], function (sdk) {
    class UsrFrameComponent extends HTMLElement {
        ...
        _loadFrame() {
            ...
            let frame = `<iframe id="content-server-iframe" src="${this._frameConfig.src}?objId=${objId}" style="${this._frameConfig.style}" sandbox="${this._frameConfig.sandbox}" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`;
